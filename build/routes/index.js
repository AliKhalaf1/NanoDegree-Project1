...
routes.get('/', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var width, height, originalFilename, outputFilename, filename;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                // File exists in path
                res.sendFile("/images/editedImages/".concat(outputFilename), { root: '.' });
                return [3 /*break*/, 3];
            case 1: 
            // File doesnt exist in path
            return [4 /*yield*/, (0, resize_1.default)(width, height, filename, outputFilename)];
            case 2:
                // File doesnt exist in path
                _a.sent();
                res.sendFile("/images/editedImages/".concat(outputFilename), { root: '.' });
